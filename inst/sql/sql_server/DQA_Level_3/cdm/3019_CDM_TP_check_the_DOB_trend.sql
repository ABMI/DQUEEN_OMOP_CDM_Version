...
insert into @resultSchema.dq_check_result
 select
  ...
  (
    ...
    from
    (select
      substring(convert(varchar,birth_datetime,121),0,8) as year_month
...
select
  ...
  ,p1.p_90
from
  (select null as check_id, stratum1, stratum2, stratum5, count_val from @resultSchema.dq_check_result
      where check_id = 'C19' )as s1
left join
(select distinct
	 stratum2
