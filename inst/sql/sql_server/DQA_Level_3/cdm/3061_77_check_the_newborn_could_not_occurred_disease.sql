...
,datediff(day,p1.birth_datetime,d1.condition_start_date) as stratum3
...
from @cdmSchema.condition_occurrence
 ...
 (select stratum2 from @resultSchema.dq_check where check_id = 'C77')
